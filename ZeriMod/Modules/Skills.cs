...
using ZeriMod;
using UnityEngine;
using ZeriMod.Modules.Survivors;
...
namespace ZeriMod.Modules
{
    ...
    internal static class Skills
    {
        ...
        public static void CreateSkillFamilies(GameObject targetPrefab, bool destroyExisting = true)
        {
            ...
            string prefix = MyCharacter.ZERI_PREFIX;

            SkillLocator skillLocator = targetPrefab.GetComponent<SkillLocator>();

            skillLocator.passiveSkill.icon = Assets.mainAssetBundle.LoadAsset<Sprite>("zerip");
        ...
        public static T CreateSkillDef<T>(SkillDefInfo skillDefInfo) where T : SkillDef
        {
            ...
            ZeriMod.Modules.Content.AddSkillDef(skillDef);
