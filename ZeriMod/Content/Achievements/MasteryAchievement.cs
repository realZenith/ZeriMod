...
namespace ZeriMod.Modules.Achievements
{
    internal class MasteryAchievement : BaseMasteryUnlockable
    {
        public override string AchievementTokenPrefix => HenryPlugin.DEVELOPER_PREFIX + "_ZERI_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => HenryPlugin.DEVELOPER_PREFIX + "_ZERI_UNLOCKABLE_REWARD_ID";
